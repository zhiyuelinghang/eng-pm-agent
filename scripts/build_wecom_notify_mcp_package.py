...
SOURCE_DIR = PROJECT_ROOT / "mcp-packages" / "wecom-notify"
...
PACKAGE_ROOT_NAME = "wecom-notify-mcp"
ROOT_DISTRIBUTIONS = ("httpx",)
_IGNORED_PARTS = frozenset(
    {"__pycache__", "tests", "test", "testing", "docs", "examples"},
)
...
def build(output: Path) -> tuple[Path, str, list[str]]:
    ...
    with tempfile.TemporaryDirectory(prefix="wecom-notify-mcp-") as raw_temp:
