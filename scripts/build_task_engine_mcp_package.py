...
SOURCE_DIR = PROJECT_ROOT / "mcp-packages" / "task-engine"
...
PACKAGE_ROOT_NAME = "task-engine-mcp"
ROOT_DISTRIBUTIONS = (
    "httpx",
    "SQLAlchemy",
    "psycopg",
...
def build(output: Path) -> tuple[Path, str, list[str]]:
    ...
    with tempfile.TemporaryDirectory(prefix="task-engine-mcp-") as raw_temp:
