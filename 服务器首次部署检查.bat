...
"%PYTHON_EXE%" -c "import os, sys; sys.path.insert(0, os.environ['PROJECT_ROOT']); import agentscope; from agentscope.app.storage import AsyncSQLAlchemyStorage; import aiosqlite, asyncpg, alembic, psycopg, pgvector, sqlalchemy, pypdf, pandas, openpyxl, xlrd, docx, pptx, pdfplumber, pypdfium2, PIL, rapidocr_onnxruntime; assert agentscope.__version__ == '2.0.7'"
if errorlevel 1 (
