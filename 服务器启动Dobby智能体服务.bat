...
"%PYTHON_EXE%" -c "import agentscope; import aiosqlite, qdrant_client, sqlalchemy; assert agentscope.__version__ == '2.0.5'" >nul
if errorlevel 1 (
...
set "AGENTSCOPE_SQLITE_PATH=%RUNTIME_HOME%\agentscope-v2.db"
