...
import type {
  ApiDaily, ApiDraft, ApiFill, ApiLink, ApiLog, ApiMember, ApiPlatformMapping,
  ApiProject, ApiProjectSettings, ApiQualityMetric, ApiRisk, ApiTask, ApiWbs,
  MemberWriteInput, ProjectBaseInfoInput,
} from './appApiTypes'
export type { ProjectBaseInfoInput } from './appApiTypes'
...
export const useAppStore = defineStore('app', () => {
  ...
  async function createTask(payload: {
    generation_origin_token?: string
