...
.folder-tree { flex:0 0 208px; min-width:0; overflow:auto; padding:12px 8px; border-right:1px solid var(--border-default); background:linear-gradient(180deg,#fbfcfb,#f6f8f7); scrollbar-gutter:stable; }
...
.folder-tree-nav { display:grid; align-content:start; gap:1px; }.tree-row { display:flex; align-items:center; min-width:0; }.tree-depth-1 { padding-left:14px; }.tree-depth-2 { padding-left:28px; }.tree-depth-3 { padding-left:42px; }.tree-depth-4 { padding-left:56px; }
.tree-toggle,.tree-spacer { flex:0 0 22px; width:22px; height:28px; }.tree-toggle { display:grid; place-items:center; border:0; border-radius:4px; padding:0; color:#6f8985; background:transparent; cursor:pointer; }.tree-toggle:hover { color:#174f49; background:#e6f0ed; }.tree-item { display:flex; flex:1 1 auto; align-items:center; min-width:0; gap:7px; height:28px; border:0; border-radius:5px; padding:0 7px 0 4px; color:#405f5b; background:transparent; font:inherit; font-size:12px; font-weight:650; text-align:left; cursor:pointer; transition:background .16s ease, color .16s ease; }.tree-item>svg { flex:0 0 auto; color:#d58a17; }.tree-item>span { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }.tree-item:hover { color:#173b37; background:#edf5f2; }.tree-item.is-active { color:#173b37; background:#dcece7; font-weight:800; }.tree-item:focus-visible,.tree-toggle:focus-visible { outline:2px solid rgba(15,118,110,.48); outline-offset:-2px; }
