...
export const mockTasks: Task[] = [
  { id: 't1', title: '深基坑坍塌风险预警 — 基坑开挖阶段', type: 'risk_alert', riskLevel: 'critical', projectId: 'p1', linkedWbsIds: ['w5'], linkedRiskId: 'r1', responsibleId: 'm2', confirmatorId: 'm1', deadline: '2026-06-12', status: 'processing', missingCount: 2, triggerReason: 'WBS 工序「基坑开挖」计划于 2026-06-01 开始，距当前日期触发提前 7 天提醒规则', workflowSteps: [], createdAt: '2026-06-03' },
  { id: 't2', title: '地面沉降监测材料缺项', type: 'material_missing', riskLevel: 'high', projectId: 'p1', linkedWbsIds: ['w5'], linkedRiskId: 'r3', responsibleId: 'm2', confirmatorId: 'm1', deadline: '2026-06-10', status: 'overdue', missingCount: 1, triggerReason: '风险上报草稿生成时检测到「地表沉降监测报告」缺失', workflowSteps: [], createdAt: '2026-06-05' },
  { id: 't3', title: '日报解析确认 — 2026-06-09 施工日报', type: 'daily_confirm', riskLevel: 'low', projectId: 'p1', linkedWbsIds: [], responsibleId: 'm3', confirmatorId: 'm3', deadline: '2026-06-10', status: 'pending', missingCount: 0, triggerReason: '微信群日报目录发现新文件「2026-06-09日报.docx」，解析完成待人工确认', workflowSteps: [], createdAt: '2026-06-10' },
  { id: 't4', title: '风险草稿审核 — 深基坑风险进展上报', type: 'draft_review', riskLevel: 'critical', projectId: 'p1', linkedWbsIds: [], linkedRiskId: 'r1', responsibleId: 'm3', confirmatorId: 'm1', deadline: '2026-06-11', status: 'waiting_confirm', missingCount: 0, triggerReason: '深基坑风险进展草稿已准备，需资料负责人审核确认后生成填报包', workflowSteps: [], createdAt: '2026-06-09' },
  { id: 't5', title: '顶管推进偏差风险预警 — 提前 14 天准备材料', type: 'risk_alert', riskLevel: 'high', projectId: 'p1', linkedWbsIds: ['w9'], linkedRiskId: 'r2', responsibleId: 'm2', confirmatorId: 'm3', deadline: '2026-06-23', status: 'pending', missingCount: 3, triggerReason: 'WBS 工序「DN2200 顶管推进」计划于 2026-06-26 开始，触发 14 天提前预警', workflowSteps: [], createdAt: '2026-06-10' },
  { id: 't6', title: '平台填报 — 深基坑风险进展上报（股份平台）', type: 'fill_platform', riskLevel: 'critical', projectId: 'p1', linkedWbsIds: [], linkedRiskId: 'r1', responsibleId: 'm3', confirmatorId: 'm3', deadline: '2026-06-12', status: 'pending', missingCount: 0, triggerReason: '草稿已确认，填报包已生成，等待启动网页填报助手', workflowSteps: [], createdAt: '2026-06-09' },
]
