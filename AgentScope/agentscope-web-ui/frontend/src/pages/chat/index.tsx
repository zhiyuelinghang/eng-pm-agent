...
const ChatPageInner = () => {
	...
	const handleUpdateAgentCallConfig = useCallback(
		async (agentId: string, callConfig: Parameters<typeof updateAgent>[1]['call_config']) => {
			if (!callConfig) return;
			await updateAgent(agentId, { call_config: callConfig }, { silent: true });
		},
		[updateAgent],
	);
