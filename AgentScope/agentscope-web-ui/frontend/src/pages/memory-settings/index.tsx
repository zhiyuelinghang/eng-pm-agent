			...
			<main className="min-h-0 flex-1 overflow-y-auto p-4 sm:p-5">
				<div className="mx-auto max-w-7xl space-y-4">
					<Tabs defaultValue="model" className="gap-4">
						<TabsList className="h-auto w-full flex-wrap justify-start bg-background p-1 ring-1 ring-border">
							...
							<Card>
								...
								<CardContent className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
									...
									<NumberField
										...
										step={0.05}
										onChange={(value) =>
											update('fusion_weight_timeline', value)
										}
									/>
									<NumberField
										...
										step={0.05}
										onChange={(value) =>
											update('fusion_weight_experience', value)
										}
									/>
									<NumberField
										...
										step={0.05}
										onChange={(value) =>
											update('fusion_weight_graphrag', value)
										}
									/>
									<NumberField
							...
							<Card>
								...
								<CardContent className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
									<NumberField
										...
										step={0.01}
										onChange={(value) =>
											update('compression_trigger_ratio', value)
										}
									/>
									<NumberField
										...
										max={200}
										onChange={(value) =>
											update('compression_keep_messages', value)
										}
									/>
									<div className="space-y-2 rounded-lg border bg-background p-4">
										<Label className="text-sm font-medium">
									...
									<NumberField
										...
										step={0.01}
										onChange={(value) =>
											update('historian_trigger_ratio', value)
										}
									/>
									<NumberField
						...
						<TabsContent value="prompts" className="space-y-4">
							<div className="flex items-start gap-3 rounded-lg border border-primary/20 bg-primary/5 p-4 text-sm">
								...
								<p className="leading-relaxed">
									{t('memory-settings.prompts.notice')}
								</p>
							</div>
							<PromptEditor
							...
							<PromptEditor
								...
								onChange={(value) =>
									update('compression_incremental_prompt', value)
								}
								rows={16}
							/>
							<PromptEditor
