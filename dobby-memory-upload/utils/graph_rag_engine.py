        ...
        try:
            ...
            async def _llm(
                ...
                **kwargs: Any,
                ...
                """Call DeepSeek API for entity extraction and summarization."""
                import httpx
                messages = []
                if system_prompt:
                ...
                async with httpx.AsyncClient() as client:
                    resp = await client.post(
                        f"{_cfg.DEEPSEEK_BASE_URL}/v1/chat/completions",
                        headers={"Authorization": f"Bearer {_cfg.DEEPSEEK_API_KEY}"},
                        json={
