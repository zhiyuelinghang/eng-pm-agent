...
async def _call_model(msgs: list, intent: str | None = None):
    ...
    model = _build_model(intent=intent)
    last_content = ""
...
_mem0_instance = None
_mem0_lock = None  # lazy-imported threading.Lock
    ...
    if provider == "dashscope":
        ...
        embedder_config = {
            ...
            "config": {
                ...
                "api_key": _cfg.DEEPSEEK_API_KEY,
                "openai_base_url": _cfg.DEEPSEEK_BASE_URL,
            },
        }
...
def get_mem0():
    ...
    """
    global _mem0_instance, _mem0_lock
...
async def _generate_final_answer(state: dict) -> str:
    ...
    try:
        resp = await _call_model(context)
