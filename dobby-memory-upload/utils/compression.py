...
def build_compress_messages(
    ...
    user_text = COMPRESS_USER.format(
    ...
    if existing_summary and existing_summary != "(无)":
        user_text = COMPRESS_USER_INCREMENTAL.format(
    ...
    return [
        SystemMsg("compressor", COMPRESS_SYSTEM),
